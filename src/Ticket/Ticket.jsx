...
const Ticket = ({ticket, countProgress, setCountProgress, selectedTickets, setSelectedTickets}) => {
    ...
    const handleTicketClick = (clickTicket)=>{
        if(!isSelected){
            setIsSelected(true)
    ...
    return (
        <div aria-disabled={isSelected} onClick={()=> handleTicketClick(ticket)} className='p-3 md:p-5 bg-white rounded-[5px] space-y-4 md:space-y-7'>
