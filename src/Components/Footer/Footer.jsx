...
const Footer = () => {
    return (
        <div className='bg-black w-full px-[40px] md:px-[80px] py-[20px] md:py-[40px] '>
            <div className='flex flex-col md:flex-row gap-10 md:gap-25'>
                ...
                <div className='space-y-2 md:space-y-4'>
                    ...
                    <p className='font-normal text-[16px] text-[#A1A1AA]'><i className="fa-brands fa-x-twitter flex items-center gap-3"></i>@CS — Ticket System</p>
                    <p className='font-normal text-[16px] text-[#A1A1AA]'><i className="fa-brands fa-linkedin-in flex items-center gap-3"></i>@CS — Ticket System</p>
                    <p className='font-normal text-[16px] text-[#A1A1AA]'><i className="fa-brands fa-facebook"></i>@CS — Ticket System</p>
                    <p className='font-normal text-[16px] text-[#A1A1AA] flex items-center gap-3'><i className="fa-solid fa-envelope"></i>support@cst.com</p>
                </div>
            </div>
            <h1 className='font-normal text-[16px] text-[#FAFAFA] flex justify-center '>© 2025 CS — Ticket System. All rights reserved.</h1>
        </div>
    );
};
